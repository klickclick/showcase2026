  ...
  return (
    ...
    >
      <motion.h1
        ...
        className="text-4xl md:text-8xl font-display font-bold uppercase italic tracking-wide mb-8 md:mb-12 text-center md:text-left text-transparent bg-clip-text bg-gradient-to-br from-white to-gray-500"
      >
        Select Squad
      </motion.h1>
